...
from ffmeshsplat.main import hello_world, get_version, main
...
class TestMainFunctions:
    ...
    def test_hello_world_without_name(self) -> None:
        ...
        assert "FFMeshSplat" in result
        assert result == "Hello from FFMeshSplat!"
    ...
    def test_hello_world_with_name(self) -> None:
        ...
        assert "FFMeshSplat" in result
        expected = f"Hello, {name}, from FFMeshSplat!"
